...
with_logger(debuglogger) do
    model = initialize_antworld(;number_ants = 125, random_seed = 6666, pheremone_amount = 60, evaporation_rate = 5)
    if !video
        ## GLMakie.activate!() # needs to happen here
        params = Dict(
